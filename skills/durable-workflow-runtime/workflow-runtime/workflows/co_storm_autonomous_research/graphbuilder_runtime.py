...
def _template_context_from_state(state: workflow_state.CoStormAutonomousResearchWorkflowState) -> dict:
    ...
    context.update(
        ...
        "expert_roster": _format_prompt_value(getattr(state, 'expert_roster', None)),
        "conversation_transcript": _format_prompt_value(getattr(state, 'conversation_transcript', None)),
        "knowledge_map_summary": _format_prompt_value(getattr(state, 'knowledge_map_summary', None)),
        "evidence_registry": _format_prompt_value(getattr(state, 'evidence_registry', None)),
        "coverage_map": _format_prompt_value(getattr(state, 'coverage_map', None)),
        ...
        "coverage_decision_rationale": _format_prompt_value(getattr(state, 'coverage_decision_rationale', None)),
        "next_round_validation_plan": _format_prompt_value(getattr(state, 'next_round_validation_plan', None)),
        "report_scope_status": _format_prompt_value(getattr(state, 'report_scope_status', None)),
        "round_decision": _format_prompt_value(getattr(state, 'round_decision', None)),
        "coverage_sufficient": _format_prompt_value(getattr(state, 'coverage_sufficient', None)),
        "ready_for_report": _format_prompt_value(getattr(state, 'ready_for_report', None)),
        "reorganization_summary": _format_prompt_value(getattr(state, 'reorganization_summary', None)),
        "reorganization_count": _format_prompt_value(getattr(state, 'reorganization_count', None)),
        "outline": _format_prompt_value(getattr(state, 'outline', None)),
        "report_path": _format_prompt_value(getattr(state, 'report_path', None)),
        "report_summary": _format_prompt_value(getattr(state, 'report_summary', None)),
        "report_sections": _format_prompt_value(getattr(state, 'report_sections', None)),
        "quality_verdict": _format_prompt_value(getattr(state, 'quality_verdict', None)),
        "quality_findings": _format_prompt_value(getattr(state, 'quality_findings', None)),
        "citation_coverage_summary": _format_prompt_value(getattr(state, 'citation_coverage_summary', None)),
        "report_ready": _format_prompt_value(getattr(state, 'report_ready', None)),
        "verified_report_path": _format_prompt_value(getattr(state, 'verified_report_path', None)),
        "report_repair_summary": _format_prompt_value(getattr(state, 'report_repair_summary', None)),
        "repair_actions": _format_prompt_value(getattr(state, 'repair_actions', None)),
